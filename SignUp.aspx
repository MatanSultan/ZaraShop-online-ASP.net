    ...
    <div class ="navbar navbar-red navbar-fixed-top" role ="navigation">
            <div class ="container ">
                <div class ="navbar-header">
                    ...
                    <a class ="navbar-brand" href ="SignIn.aspx" ><span ><img src="Zara_Logo.svg" alt="ZaraShop" height ="30" /></span> </a>
        ...
        <footer class="footer-pos">
         ...
         <!---Footer COntents End---->
        <asp:Button ID="Button1" runat="server" Height="54px" OnClick="Button1_Click" Text="submit" Width="267px" />
    </form>
</body>
</html>
